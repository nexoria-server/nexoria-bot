...
TEAM_PANEL_CHANNEL_ID = settings.TEAM_PANEL_CHANNEL_ID

# Mod-Logs
MOD_LOG_CHANNEL_ID = settings.MOD_LOG_CHANNEL_ID

# Bestehende SQLite-Datenbank
DATABASE_FILE = settings.TEAM_DB_PATH
...
PROMOTION_ORDER = [
    settings.TEST_SUPPORTER_TEAM_ROLE_ID,
    settings.SUPPORTER_ROLE_ID,
    settings.MODERATOR_ROLE_ID,
    settings.MODERATOR_PLUS_ROLE_ID,
...
STAR_GIVER_ROLES = {
    settings.ADMIN_ROLE_ID,
    settings.CO_OWNER_ROLE_ID,
    settings.OWNER_ROLE_ID,
}

# Wer das Team-Panel benutzen darf
TEAM_PANEL_ROLES = {
    role_id for _, _, role_id in TEAM_ROLES if role_id
}
...
PROMOTION_ORDER = [role_id for role_id in PROMOTION_ORDER if role_id]
STAR_GIVER_ROLES.discard(0)
BAN_ROLES.discard(0)
