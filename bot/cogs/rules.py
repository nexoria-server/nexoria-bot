...
DISCORD_RULES_CHANNEL_ID = settings.DISCORD_RULES_CHANNEL_ID
MINECRAFT_RULES_CHANNEL_ID = settings.MINECRAFT_RULES_CHANNEL_ID
    ...
    async def regeln(
        ...
        if not channel_id:
            await interaction.response.send_message(
                "❌ Für dieses Regelwerk wurde noch kein Kanal konfiguriert.",
                ephemeral=True,
            )
            return
