...
APPLICATION_PANEL_CHANNEL_ID = settings.APPLICATION_PANEL_CHANNEL_ID
APPLICATION_CATEGORY_ID = settings.APPLICATION_CATEGORY_ID
APPLICATION_LIST_CHANNEL_ID = settings.APPLICATION_LIST_CHANNEL_ID
APPLICATION_SEARCH_CHANNEL_ID = settings.APPLICATION_SEARCH_CHANNEL_ID

MEDIA_ROLE_ID = settings.MEDIA_ROLE_ID
TEST_SUPPORTER_ROLE_ID = settings.TEST_SUPPORTER_ROLE_ID
BUILDER_ROLE_ID = settings.BUILDER_ROLE_ID

# Neue Auto-Rollen
DEVELOPER_ROLE_ID = settings.DEVELOPER_ROLE_ID
PARTNER_ROLE_ID = settings.PARTNER_ROLE_ID

DATA_FILE = settings.DATA_DIR / "applications.json"
